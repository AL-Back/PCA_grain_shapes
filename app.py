...
app.layout = html.Div([
    ...
    html.Div([
        html.P(
            ...
            'The displayed images have a fixed size but the aspect ration is kept. PC1 likely sorts the grains by size (visible thanks to the image resolution), PC2 by roundness, and PC3 by roughness.')],
